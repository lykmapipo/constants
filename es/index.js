...
import { values, map, keys, flattenDeep } from 'lodash';
 ...
 * // => 'Dar es Salaam'
 */
const DEFAULT_CITY_NAME = getString(
  'DEFAULT_CITY_NAME',
  'Dar es Salaam'
);

export { CALLING_CODES, CONTINENT_NAMES, COUNTRY_CODES, COUNTRY_NAMES, DEFAULT_CALLING_CODE, DEFAULT_CITY_NAME, DEFAULT_CONTINENT_NAME, DEFAULT_COUNTRY_CODE, DEFAULT_COUNTRY_NAME, DEFAULT_DATETIME_FORMAT, DEFAULT_DATE_FORMAT, DEFAULT_LOCALE, DEFAULT_TIMEZONE, DEFAULT_TIME_FORMAT, LOCALES, TIMEZONES };
